...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        if data_args.train_file is not None:
            ...
            extension = data_args.train_file.split(".")[-1] #json
    ...
    if (
        ...
        and model.config.max_position_embeddings < data_args.max_source_length #default: 1024
    ):
    ...
    def preprocess_function(examples):
        ...
        model_inputs["text_labels"] = targets
    ...
    data_collator = DataCollatorForSeq2Seq(
        ...
        pad_to_multiple_of=8 if training_args.fp16 else None, #If set will pad the sequence to a multiple of the provided value.
    )
    ...
    def compute_metrics(eval_preds):
        ...
        if training_args.do_eval:
            metrics = metric(decoded_preds,eval_dataset["original_labels"])
        else:
            return {}
        # metrics
        # {
    ...
    if training_args.do_predict:
        ...
        if trainer.is_world_process_zero():
            if training_args.predict_with_generate:
                ...
                #print(predictions)
                with jsonlines.open(data_args.output_file, "w") as f:
